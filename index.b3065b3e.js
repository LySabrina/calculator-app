...
})({"8RQab":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "fa7ab74eb3065b3e";
"use strict";
...
},{}],"9HIGx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _calculatorMjs = require("./calculator.mjs");
var _calculatorMjsDefault = parcelHelpers.interopDefault(_calculatorMjs);
const display = document.querySelector(".calculator__display");
display.textContent = (0, _calculatorMjsDefault.default).getFirstNum();
...
const sound = new URL(require("418e697a8061bba"));
 ...
 */ function handleNumInputs(btn) {
    ...
    if ((0, _calculatorMjsDefault.default).getOperator() === undefined || (0, _calculatorMjsDefault.default).getOperator() === "equal") //using old value of input result
    (0, _calculatorMjsDefault.default).setFirstNum(num);
    else (0, _calculatorMjsDefault.default).setSecondNum(num);
    console.log("index 1st num ", (0, _calculatorMjsDefault.default).getFirstNum());
    console.log("index 2nd num ", (0, _calculatorMjsDefault.default).getSecondNum());
}
/**
 ...
 */ function handleOperators(btn) {
    ...
    switch(value){
        case "equal":
            if ((0, _calculatorMjsDefault.default).getFirstNum() !== undefined || (0, _calculatorMjsDefault.default).getSecondNum() !== undefined) {
                console.log("operationsss", (0, _calculatorMjsDefault.default).getOperator());
                //Now that we have both firstNum and secondNum defined with values, we call the calculator operation
                (0, _calculatorMjsDefault.default).operate((0, _calculatorMjsDefault.default).getOperator());
                const result = (0, _calculatorMjsDefault.default).getTotal();
                console.log("total - " + result);
                display.textContent = result;
                //delete?
                (0, _calculatorMjsDefault.default).setOperator("equal"); //we set our operator of calculator to equal now because, a user can proceed to start a brand new calculation or continue from their previous result
        ...
        case "reset":
            ...
            (0, _calculatorMjsDefault.default).setFirstNum(0);
            (0, _calculatorMjsDefault.default).setSecondNum(undefined);
            (0, _calculatorMjsDefault.default).setOperator(undefined);
            break;
        default:
            inputNum = "";
            if ((0, _calculatorMjsDefault.default).getOperator() != undefined) {
                (0, _calculatorMjsDefault.default).operate((0, _calculatorMjsDefault.default).getOperator());
                const currentTotal = (0, _calculatorMjsDefault.default).getFirstNum(); //why firstNum instead of total? Because inside calculator, the firstNum will equal to the newly operation total. Total variable may still ho
                display.textContent = currentTotal;
            }
            const operator = value;
            (0, _calculatorMjsDefault.default).setOperator(operator);
            break;
    }
}
...
},{}],"dUzxE":[function(require,module,exports) {
module.exports = require("9eaf3945a97a75fb").getBundleURL("lvikS") + "button-click.29f47172.wav" + "?" + Date.now();

},{"9eaf3945a97a75fb":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["8RQab","9HIGx"], "9HIGx", "parcelRequire06f1")

//# sourceMappingURL=index.b3065b3e.js.map
